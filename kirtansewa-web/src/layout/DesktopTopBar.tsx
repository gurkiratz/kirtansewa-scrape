    ...
    <header className="hidden md:flex h-14 shrink-0 border-b border-border bg-surface items-center gap-4 px-5 z-20">
      <div className="flex-1 relative">
        ...
        <input
          ...
          className="w-full bg-card border border-border rounded-md pl-8 pr-3 py-1.5 text-sm text-text-primary placeholder:text-text-primary/50 focus:outline-none focus:border-gold/50 transition-colors"
        />
      </div>
